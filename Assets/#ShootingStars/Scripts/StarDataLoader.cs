...
public class StarDataLoader {//MonoBehavior removed because class only used to manage the data
    ...
    public class Star {
        ...
        public Star(float catalog_number, double right_ascension, double declination, byte spectral_type,byte spectral_index, short magnitude, float ra_proper_motion, float dec_proper_motion) {
    ...
    public List<Star> LoadData()
    {
        ...
        for (int i = 0; i < num_stars; i++) {
            ...
            //Spectral type: infers color of the star
